...
import {selectCart, selectCartProductsCount} from '@/features/cartSlice'
...
const TheHeader = () => {
    ...
    const cartProductsCount: { id: number; count: number }[] = useSelector(selectCartProductsCount)
    ...
    let totalItemCount = cartProductsCount
        .map(it => it.count)
            ...
            <div className={style.header__wrapper}>
                <nav className={style.header__nav}>
                    <ul className={style.header__nav_list}>
                        ...
                        <SubMenu label='Дівчатам'/>
                        <SubMenu label='Хлопчикам'/>
                    </ul>
                </nav>
                <Link href='/'>
                    <Image
